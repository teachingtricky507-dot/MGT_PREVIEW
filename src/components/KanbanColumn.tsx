...
export const KanbanColumn: React.FC<KanbanColumnProps> = ({ id, title, issueIds, children, hideHeader }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`p-2 flex-1 overflow-y-auto custom-scrollbar ${hideHeader ? 'min-h-[80px]' : ''}`}>
        {children}
      </div>
    </div>
  );
